...
def parse_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Skip clang/llvm check tests after stage1.')

    parser.add_argument(
        '--skip-tests2',
        action='store_true',
        default=False,
        help='Skip clang/llvm check tests after stage2.')
...
def main():
    ...
    if not args.skip_tests2 and need_host:
        stage2.test()
