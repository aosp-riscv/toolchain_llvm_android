...
def install_wrappers(llvm_install_path):
    ...
    go_env['PATH'] = paths.GO_BIN_PATH + os.pathsep + go_env['PATH']
...
def package_toolchain(toolchain_builder,  dist_dir, necessary_bin_files: Optional[Set[str]]=None,
    ...
    version = toolchains.get_toolchain_from_builder(toolchain_builder).version
