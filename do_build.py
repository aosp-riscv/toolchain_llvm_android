...
class LibCxxBuilder(LibCxxBaseBuilder):
    ...
    def cmake_defines(self) -> Dict[str, str]:
        ...
        defines['LIBCXX_CXX_ABI_LIBRARY_PATH'] = str(builders.BuilderRegistry.get('libcxxabi').install_dir / 'lib64')
        return defines
...
class WindowsToolchainBuilder(builders.LLVMBuilder):
    ...
    def ldflags(self) -> List[str]:
        ...
        libcxx_lib = builders.BuilderRegistry.get('libcxx').install_dir / 'lib64'
    ...
    def cxxflags(self) -> List[str]:
        ...
        # building libc++.
        cxx_headers = builders.BuilderRegistry.get('libcxx').install_dir / 'include' / 'c++' / 'v1'
