...
def clang_prebuilt_base_dir():
    return utils.android_path('prebuilts/clang/host',
                              hosts.build_host().os_tag, global_configs.CLANG_PREBUILT_VERSION)
...
def base_cmake_defines():
    ...
    if hosts.build_host().is_darwin:
        ...
        defines['CMAKE_OSX_DEPLOYMENT_TARGET'] = global_configs.MAC_MIN_VERSION
...
class Stage1Builder(builders.LLVMBuilder):
    ...
    def additional_ldflags(self) -> List[str]:
        ...
        lib_dir = self.toolchain.lib_path
