...
from data import CNSData, WorkNodeRecord, WorkRecord
import utils
...
class AndroidBuildClient():
    ...
    def get_worknode_status(self, forrest_invocation_id: str,
                            tag: str) -> Tuple[bool, List[WorkRecord]]:
    ...
    for pending in CNSData.PendingWorkNodes.records:
        ...
        if not complete:
            ...
            for result in results:
                CNSData.TestRecords.addTest(result, writeBack=False)
