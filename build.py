...
def package_toolchain(build_dir, build_name, host, dist_dir, strip=True):
    ...
    # Windows should have LLVMgold.dll under lib64.
    if is_windows and not os.path.isfile(os.path.join(install_dir, 'lib64', 'LLVMgold.dll')):
        raise RuntimeError('Did not find LLVMgold.dll under lib64')
