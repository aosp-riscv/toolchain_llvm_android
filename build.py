...
def create_ubsan_standalone_symlink(stage2_install, clang_version):
    lib_dir = os.path.join(stage2_install,
                           clang_resource_dir(clang_version.long_version(), ''))
    for arch in ('aarch64', 'arm', 'i686', 'x86_64'):
        os.symlink('libclang_rt.ubsan_standalone-{}-android.a'.format(arch),
                   lib_dir + 'libclang_rt.ubsan_standalone_static-{}-android.a'.format(arch))
...
def build_runtimes(stage2_install):
    ...
    create_ubsan_standalone_symlink(stage2_install, version)
