...
class ArgParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        self.add_argument(
            'build', metavar='BUILD',
            help='Toolchain build number to test.')
...
def prepare_ab_test_topic(toolchain_build: ToolchainBuild):
...
def do_prechecks():
    ...
    try:
        utils.check_call(['prodcertstatus', '-q',
                          '--check_remaining_hours', '1'])
